...
/**
 * In order to participate in a battle to occupy the Brigands Hideaway clan hall, the head of a clan of level 4 or above must complete the Brigands Hideaway quest within a certain time before the clan hall battle is started. Only the first five clans that complete the hideaway quest first can
 * participate. The number of clan members that can participate per clan is limited to 18 people. The quest to participate in the Brigands Hideaway clan hall battle is only valid for participating in the clan hall battle on that date. Having completed the quest previously does not make it possible
